...
function ResidentForm() {
    ...
    useEffect(() => {
      ...
      const handleSubmit = () => {
        if (newUserName && newUserPhoneAreaCode && newUserPhonePrefix && newUserPhoneoLocalx && newUserEmail && newUserAddress1 && newUserAddress2 && newUserCity && newUserStateLocal && newUserZipCode) {
            const newUser = {
                contact: {   
                    name: newUserName, 
                    email: newUserEmail, 
                    phone: [newUserPhoneAreaCode, newUserPhonePrefix, newUserPhoneoLocalx ],
                },
    ...
    return (
                ...
                <div className='input-areas'>
                    ...
                    <div className='resident_phone-number'>
                        <input 
                            ...
                            onChange={(e) => setNewUserPhoneAreaCode(e.target.value)}
                            required
                        />
                        - 
                        <input 
                            ...
                            onChange={(e) => setNewUserPhonePrefix(e.target.value)}
                            required
                        />
                        -
                        <input 
                            ...
                            onChange={(e) => setNewUserPhoneLocalx(e.target.value)}
                            required
                        />
                    </div>
            ...
            <div className='resident_address'>
                ...
                <div className='input-areas'>
                    ...
                    <input 
                        ...
                        onChange={(e) => setNewUserStateLocal(e.target.value)}
                        required
                    />
                    <input 
                        type='text'
        ...
        <button className='resident_form-btn' onClick={handleSubmit}>Submit</button>
        </div>
    );
};
